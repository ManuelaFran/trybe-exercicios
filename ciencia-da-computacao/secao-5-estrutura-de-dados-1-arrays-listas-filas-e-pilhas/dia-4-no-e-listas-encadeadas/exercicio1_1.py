# Após criada as operações anteriores (no exercício 1), refatore os seguintes
# métodos para que utilizem a __get_node_at ante iterações:
# insert_at;
# insert_last;
# remove_last;
# remove_at;
...
class LinkedList:
    ...
    def insert_last(self, value):
        ...
        actual_last_value = self.get_node_at(len(self) - 1)
    ...
    def remove_last(self):
        ...
        previous_to_be_removed = self.get_node_at(len(self) - 2)
